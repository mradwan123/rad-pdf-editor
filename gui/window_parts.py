...
if TYPE_CHECKING:
    ...
    class WindowPart(QMainWindow):
        ...
        markup_actions: dict[str, QAction]
        canvas_tool_actions: dict[str, QAction]
        ...
        def _make_markup_handler(self, kind: str) -> object: ...
        def _make_canvas_tool_handler(self, tool: str) -> object: ...
        def _delete_annotation_under_cursor(self) -> None: ...
        def _on_annotation_drawn(
            self, tab: DocumentTab, page: int, kind: str, payload: object
        ) -> None: ...
        def _on_annotation_moved(
            self, tab: DocumentTab, page: int, annot_id: str, rect: object
        ) -> None: ...
